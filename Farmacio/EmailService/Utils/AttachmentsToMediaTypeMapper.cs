...
namespace EmailService.Utils
{
    ...
    {
        private static readonly IDictionary<AttachmentType, string> _mappingPool;

        static AttachmentsToMediaTypeMapper()
        {
            _mappingPool = new Dictionary<AttachmentType, string>()
            {
